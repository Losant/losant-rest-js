...
module.exports = function (options, client) {
   ...
   * Parameters:
   *  {string} applicationId - ID of the associated application 
   *  {object} application - Object containing new application properties (https://api.losant.com/#/definitions/applicationPatch)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
  ...
  internals.debug = function (params, opts, cb) {
    ...
    params = params || {};
    var tpl = uriTemplate.parse('/applications/{applicationId}/debug');
    var pathParams = {};
    var req = {
      method: 'GET',
      params: { _actions: false, _links: true, _embedded: true }
