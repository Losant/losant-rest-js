...
module.exports = function (options, client) {
   ...
   * Parameters:
   *  {string} orgId - ID associated with the organization 
   *  {object} organization - Object containing new organization properties (https://api.losant.com/#/definitions/orgPatch)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   ...
   * Parameters:
   *  {string} orgId - ID associated with the organization 
   *  {object} invite - Object containing new invite info (https://api.losant.com/#/definitions/orgInvitePost)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   ...
   * Parameters:
   *  {string} orgId - ID associated with the organization 
   *  {object} member - Object containing new member pair (https://api.losant.com/#/definitions/orgMemberPatch)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
