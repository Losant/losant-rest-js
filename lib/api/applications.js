...
module.exports = function (options, client) {
   ...
   *
   * Parameters:
   *  {object} application - New application information (https://api.getstructure.io/#/definitions/applicationPost)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   * Responses:
   *  201 - Successfully created application (https://api.getstructure.io/#/definitions/application)
   *
   * Errors:
