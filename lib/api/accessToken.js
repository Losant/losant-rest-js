...
module.exports = function (options, client) {
   ...
   *
   * Errors:
   *  404 - Error if accessToken was not found (https://api.getstructure.io/#/definitions/error)
   */
  internals.get = function (params, opts, cb) {
    ...
    params = params || {};
    var tpl = uriTemplate.parse('/access-tokens/{accessTokenId}');
    var pathParams = {};
    var req = {
      method: 'GET',
   ...
   * Parameters:
   *  {string} accessTokenId - ID associated with the accessToken 
   *  {object} accessToken - Object containing new properties of the accessToken (https://api.getstructure.io/#/definitions/accessTokenPatch)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   ...
   *
   * Responses:
   *  200 - If accessToken was successfully deleted (https://api.getstructure.io/#/definitions/success)
   *
   * Errors:
   *  404 - Error if accessToken was not found (https://api.getstructure.io/#/definitions/error)
   */
