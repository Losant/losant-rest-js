...
module.exports = function (options, client) {
   ...
   *
   * Responses:
   *  200 - Device information (https://api.getstructure.io/#/definitions/applicationKey)
   *
   * Errors:
   *  404 - Error if applicationKey was not found 
   */
   ...
   *  {string} applicationId - ID associated with the application 
   *  {string} applicationKeyId - ID associated with the applicationKey 
   *  {object} applicationKey - Object containing new properties of the applicationKey (https://api.getstructure.io/#/definitions/applicationKey)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   ...
   *
   * Responses:
   *  204 - If applicationKey was successfully deleted 
   *
   * Errors:
   *  404 - Error if applicationKey was not found 
   */
