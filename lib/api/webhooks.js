...
module.exports = function (options, client) {
   ...
   *
   * Responses:
   *  200 - Collection of webhooks (https://api.getstructure.io/#/definitions/webhooks)
   *
   * Errors:
   ...
   * Parameters:
   *  {string} applicationId - ID associated with the application 
   *  {object} webhook - New webhook information (https://api.getstructure.io/#/definitions/webhookPost)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   * Responses:
   *  201 - Successfully created webhook (https://api.getstructure.io/#/definitions/webhook)
   *
   * Errors:
