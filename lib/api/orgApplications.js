...
module.exports = function (options, client) {
   ...
   *
   * Responses:
   *  200 - Collection of org applications 
   *
   * Errors:
   */
  internals.get = function (params, opts, cb) {
    ...
    params = params || {};
    var tpl = uriTemplate.parse('/orgs/{orgId}/applications');
    var pathParams = {};
    var req = {
      method: 'GET',
   ...
   * Parameters:
   *  {string} orgId - Id of the organization 
   *  {object} application - Application information (https://api.getstructure.io/#/definitions/application)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
