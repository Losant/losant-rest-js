...
module.exports = function (options, client) {
  ...
  internals.get = function (params, opts, cb) {
    ...
    params = params || {};
    var tpl = uriTemplate.parse('/projects/{projectId}/devices/{deviceId}');
    var pathParams = {};
    var req = {
      method: 'GET',
  ...
  internals.retrieveLastReportedState = function (params, opts, cb) {
    ...
    params = params || {};
    var tpl = uriTemplate.parse('/projects/{projectId}/devices/{deviceId}/state');
    var pathParams = {};
    var req = {
      method: 'GET',
      params: { _actions: false, _links: true, _embedded: true }
   ...
   *
   * Responses:
   *  200 - If change request was successfully sent 
   *
   * Errors:
   *  404 - Error if device was not found 
   */
   ...
   *
   * Responses:
   *  200 - If state was successfully received 
   *
   * Errors:
   *  404 - Error if device was not found 
   */
  internals.reportCurrentState = function (params, opts, cb) {
    ...
    params = params || {};
    var tpl = uriTemplate.parse('/projects/{projectId}/devices/{deviceId}/report-state');
    var pathParams = {};
    var req = {
      method: 'POST',
      data: {},
   ...
   *  {string} projectId - ID associated with the project 
   *  {string} deviceId - ID associated with the device 
   *  {undefined} message - Message to send about the device 
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   * Responses:
   *  200 - If message was successfully sent 
   *
   * Errors:
   *  404 - Error if device was not found 
   */
  internals.sendMessage = function (params, opts, cb) {
    ...
    params = params || {};
    var tpl = uriTemplate.parse('/projects/{projectId}/devices/{deviceId}/send-message');
    var pathParams = {};
    var req = {
      method: 'POST',
      data: {},
