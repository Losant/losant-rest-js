...
module.exports = function (options, client) {
   ...
   *  {string} applicationId - ID associated with the application 
   *  {string} flowId - ID associated with the flow 
   *  {object} flow - Object containing new properties of the flow (https://api.losant.com/#/definitions/flowPatch)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   ...
   *  {string} applicationId - ID associated with the application 
   *  {string} flowId - ID associated with the flow 
   *  {object} button - Object containing button key and payload (https://api.losant.com/#/definitions/virtualButtonPress)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   ...
   *  {string} applicationId - ID associated with the application 
   *  {string} flowId - ID associated with the flow 
   *  {object} entry - Object containing storage entry (https://api.losant.com/#/definitions/flowStorageEntry)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
