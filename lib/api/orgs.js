...
module.exports = function (options, client) {
   ...
   *
   * Parameters:
   *  {object} organization - New organization information (https://api.getstructure.io/#/definitions/orgPost)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   * Responses:
   *  201 - Successfully created organization (https://api.getstructure.io/#/definitions/org)
   *
   * Errors:
