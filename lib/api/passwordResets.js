...
module.exports = function (options) {
  ...
  internals.post = function (params, cb) {
    ...
    params = params || {};
    var tpl = uriTemplate.parse('https://api.getstructure.io/password-resets');
    var pathParams = {};
    var req = {
      method: 'POST',
      headers: {
   ...
   */
  internals.finish = function (params, cb) {
    if ('function' === typeof params) {
      cb = params;
      params = {};
    }
    params = params || {};
    var tpl = uriTemplate.parse('https://api.getstructure.io/password-resets/finish');
    var pathParams = {};
    var req = {
      method: 'POST',
      headers: {
