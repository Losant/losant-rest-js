...
module.exports = function (options, client) {
  ...
  internals.get = function (params, opts, cb) {
    ...
    params = params || {};
    var tpl = uriTemplate.parse('/projects/{projectId}/events');
    var pathParams = {};
    var req = {
      method: 'GET',
   ...
   * Parameters:
   *  {string} projectId - ID associated with the project 
   *  {object} event - New event information (https://api.getstructure.io/#/definitions/event)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   * Responses:
   *  201 - If event was successfully created 
   *
   * Errors:
   */
