...
module.exports = function (options, client) {
   ...
   *
   * Responses:
   *  200 - Successful authentication (https://api.getstructure.io/#/definitions/authedUser)
   *
   * Errors:
   *  400 - Error if malformed request (https://api.getstructure.io/#/definitions/error)
   *  401 - Unauthorized error if authentication fails (https://api.getstructure.io/#/definitions/error)
   */
   ...
   *
   * Parameters:
   *  {object} credentials - Device authentication credentials (https://api.getstructure.io/#/definitions/deviceCredentials)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   * Responses:
   *  200 - Successful authentication (https://api.getstructure.io/#/definitions/authedDevice)
   *
   * Errors:
   *  400 - Error if malformed request (https://api.getstructure.io/#/definitions/error)
   *  401 - Unauthorized error if authentication fails (https://api.getstructure.io/#/definitions/error)
