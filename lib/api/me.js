...
module.exports = function (options, client) {
   ...
   *
   * Parameters:
   *  {object} user - Object containing new user properties (https://api.getstructure.io/#/definitions/mePatch)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   ...
   *
   * Responses:
   *  200 - If the user was successfully deleted (https://api.getstructure.io/#/definitions/success)
   *
   * Errors:
   *  400 - Error if malformed request (https://api.getstructure.io/#/definitions/error)
   */
   ...
   *
   * Responses:
   *  200 - If email verification was successfully sent (https://api.getstructure.io/#/definitions/success)
   *
   * Errors:
   *  400 - Error if malformed request (https://api.getstructure.io/#/definitions/error)
   */
   ...
   *
   * Parameters:
   *  {object} data - Object containing two factor auth properties (https://api.getstructure.io/#/definitions/enableTwoFactorAuth)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   ...
   *
   * Parameters:
   *  {object} data - Object containing two factor auth properties (https://api.getstructure.io/#/definitions/disableTwoFactorAuth)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   ...
   *
   * Parameters:
   *  {object} data - Object containing recent item info (https://api.getstructure.io/#/definitions/recentItem)
   *  {boolean} _actions - Return resource actions in response 
   *  {boolean} _links - Return resource link in response 
   *  {boolean} _embedded - Return embedded resources in response 
   *
   * Responses:
   *  200 - Updated recent item list (https://api.getstructure.io/#/definitions/recentItemList)
   *
   * Errors:
   *  400 - Error if malformed request (https://api.getstructure.io/#/definitions/error)
   */
   ...
   *
   * Responses:
   *  200 - Recent item list (https://api.getstructure.io/#/definitions/recentItemList)
   *
   * Errors:
   *  400 - Error if malformed request (https://api.getstructure.io/#/definitions/error)
   */
